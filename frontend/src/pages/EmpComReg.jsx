  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center bg-[#FEFEFF] font-montserrat pt-32 pb-20 px-4 sm:pt-44 sm:pb-32 sm:px-12 md:pt-[180px] md:pb-[120px] md:px-[240px]">
      ...
      <div className="w-full flex flex-col items-center mt-10 px-2 sm:px-4">
        <h1 className="text-2xl sm:text-3xl md:text-4xl font-bold text-[#7D1628] mb-1 md:mb-2 text-center">
        ...
        <form className="flex flex-col gap-6 sm:gap-8 items-center w-full max-w-2xl mx-auto" onSubmit={handleRegister}>
          <div className="w-full">
            ...
            <input
              type="email"
              id="email"
              className="w-full h-12 sm:h-16 md:h-[45px] px-4 sm:px-6 border-2 border-[#6B7280] bg-[#F9F9F9] rounded-xl md:rounded-xl text-sm sm:text-base md:text-lg focus:outline-none focus:ring-2 md:focus:ring-4 focus:ring-rose-200 placeholder:text-[16px] placeholder:font-semibold"
              value={email}
          ...
          <div className="w-full relative">
            ...
            <input
              ...
              id="password"
              className="w-full h-12 sm:h-16 md:h-[45px] px-4 sm:px-6 border-2 border-[#6B7280] bg-[#F9F9F9] rounded-xl md:rounded-xl text-sm sm:text-base md:text-lg focus:outline-none focus:ring-2 md:focus:ring-4 focus:ring-rose-200 placeholder:text-[16px] placeholder:font-semibold placeholder:text-[#6B7280]"
              value={password}
          ...
          <div className="w-full mt-[-16px]">
            ...
            >
              <input
                ...
                className="appearance-none w-4 h-4 rounded-md border-2 border-[#6B7280] checked:bg-[#9B1C31] checked:border-[#9B1C31] focus:outline-none transition-colors duration-200 mr-2"
                required
              />
              <span className="leading-tight text-xs sm:text-xs md:text-sm">
                ...
                <a
                  href="/termslink"
                  className="text-[#9B1C31] hover:underline"
                  target="_blank"
          ...
          <button
            type="submit"
            disabled={loading}
            className="max-w-md bg-[#9B1C31] text-white rounded-2xl hover:bg-[#7D1628] transition mt-4 h-[44px] w-[225px] font-semibold text-sm"
          >
        ...
        <p className="text-center text-sm text-[#6B7280] font-semibold mt-2">
          ...
          <a href="/employer-sign-in" className="text-[#9B1C31] hover:underline">
            Sign in
          </a>
        </p>
      </div>
